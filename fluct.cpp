...
void Evol_Temp(int N_bath, double Lambda, int N_cond, ofstream &arquivo){
...
int main(int argn, char **arg){
	...
	int N_bath = atoi(arg[1]);		// number of bath modes
     	...
     	double Lambda1 = Lambda/sqrt(N_bath);
      	...
      	ofstream arquivo;
      	arquivo.open (("For_" + string(arg[1]) + "_" + string(arg[2]) + "_" + string(arg[3]) + ".txt").c_str());

                Evol_Temp(N_bath, Lambda1, N_cond, arquivo);
